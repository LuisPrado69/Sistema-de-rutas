				...
				<div class="datagrid">
					<form method='post' class="form-horizontal form-label-left" action="bddatos/ModificaNoticiaBD.php" enctype="multipart/form-data">
						...
						<div class="item form-group">
	                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="descripccion">Noticia <span class="required">*</span>
	                        </label>
	                        <div class="col-md-6 col-sm-6 col-xs-12">
	                            <textarea id="descripccion" class="form-control col-md-7 col-xs-12" name="descripccion" class="form-control" rows="5" id="comment" placeholder="Ingrese descripcción de Noticia" title="Ingrese descripcción de Noticia" ><?php echo $eamf["descripccion"];?></textarea>
	                        </div>
	                    </div>
