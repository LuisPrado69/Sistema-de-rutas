	...
	<div id="page">
		...
		?>
			<div class="form-group">
		        <input type="password" class="form-control text-center" placeholder="Nueva Contraseña" name="pass" required />
		    </div>
		    <div class="form-group">
		        <input type="password" class="form-control text-center" placeholder="Repita Contraseña" name="confirm-pass" required />
        	</div>
     	<hr /><br>
     	<center>
