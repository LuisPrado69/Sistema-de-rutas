    ...
    <body>
	    ...
	    <div id="page">
		    <div id="content-other">
                <h2 id="otro" align="center">Registro Estado</h2>
                <hr>
			    <div class="datagrid">
				    <form method='post' class="form-horizontal form-label-left" action="bddatos/AltaEstadoBD.php" enctype="multipart/form-data">
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input id="descripccion" class="form-control col-md-7 col-xs-12" data-validate-length-range="5" data-validate-words="1" name="descripccion" placeholder="" required="required" type="text">
                            </div>
                        </div>
