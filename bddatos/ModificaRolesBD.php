...
//validación de sesión
	...
	include_once('../conn.php');
		...
		else if(mysql_query("update roles set descripccion='$descripccion' , estado = '$estado' where id='$id'"))
		{			

			date_default_timezone_set('America/Bogota');
			$fecha = date('Y-m-d H:i');
			$sql1="INSERT into sentencias values ('','$_SESSION[id]','UPDATE','ROLES SET DESCRIPCCION=','$fecha','$descripccion, WHERE ID = ,$id')";
