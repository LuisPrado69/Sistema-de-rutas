    ...
    <body>
	    ...
	    <div id="page">
		    <div id="content-other">
                <h2 id="otro" align="center">Registro de Noticia</h2>
                <hr>
			    <div class="datagrid">
				    <form method='post' class="form-horizontal form-label-left" action="bddatos/AltaNoticiaBD.php" enctype="multipart/form-data">
                        <span class="section">
						    <?php
                        ...
                        <div class="item form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="nombre_empleado">Noticia <span class="required">*</span>
                            </label>
