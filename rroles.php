...
<?php
	...
	$sql1="Insert into sentencias values ('','$_SESSION[id]','SELECT * FROM','ROLES','$fecha','')";
...
<html class="no-js" lang=""> <!--<![endif]-->
    <head>
        ...
        <script>			
			function opciones(val)
			{
				...
				if(opcion==1)
				{
					window.location= "muestra_roles.php?id="+val;
				}
				else if (opcion==2)
				{
					window.location= "modificar_roles.php?id="+val;
				}				
				else if (opcion==3)
				{
					window.location= "eliminar_roles.php?id="+val;
				}
    ...
    <body>
		...
		<div id="page">
			...
			<h2 id="otro" align="center">Lista Roles</h2>
				<div class="text-right">
					<a href="Pdf/reporte_roles.php" class="btn btn-warning" target="_blank">Reporte Roles</a>
					<a href="form_roles.php" class="btn btn-primary">Agregar Roles</a>
				</div>	
				<?php
				...
				<div class="datagrid"><br>
						<table class="table table-bordered table-striped" id="example1">
			                ...
			                <tbody>
								<?php									
									$productosq=mysql_query("select * from roles");								
